...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::get('/user/edit', [DashboardController::class, 'editPassword'])->name('user.edit');
        Route::post('/user/update', [DashboardController::class, 'updatePassword'])->name('user.update');
