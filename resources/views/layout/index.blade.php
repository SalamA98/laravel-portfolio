            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            <img src="{{ asset('imgs/pencil-case.svg') }}"
                                alt="Landing page icon" class="icon">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            <img src="{{ asset('imgs/responsive.svg') }}"
                                alt="Landing page icon" class="icon">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            <img src="{{ asset('imgs/toolbox.svg') }}"
                                alt="Landing page icon" class="icon">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            <img src="{{ asset('imgs/analytics.svg') }}"
                                alt="Landing page icon" class="icon">
    ...
    <section class="section" id="portfolio">
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="#" class="portfolio-card">
                        <img class="portfolio-card-img" src="{{asset('/imgs/folio-2.jpg')}}" class="img-responsive rounded"
                            alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>Web Designing</h5>
                ...
                <div class="col-md-4">
                    <a href="#" class="portfolio-card">
                        <img class="portfolio-card-img" src="{{asset('imgs/folio-3.jpg')}}" class="img-responsive rounded"
                            alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>Web Designing</h5>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="testimonial-card">
                        <div class="testimonial-card-img-holder">
                            <img src="{{asset('imgs/avatar2.jpg')}}" class="testimonial-card-img"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="testimonial-card">
                        <div class="testimonial-card-img-holder">
                            <img src="{{asset('imgs/avatar3.jpg')}}" class="testimonial-card-img"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                        </div>
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing
        ...
        <div class="container text-center">
            ...
            <div class="blog-card">
                <div class="blog-card-header">
                    <img src="{{asset('imgs/img-1.jpg')}}" class="blog-card-img"
                        alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
            ...
            <div class="blog-card">
                <div class="blog-card-header">
                    <img src="{{asset('imgs/img-2.jpg')}}" class="blog-card-img"
                        alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
                <div class="blog-card-body">
    ...
    <div class="container">
        <footer class="footer">
            ...
            <div class="social-links text-right m-auto ml-sm-auto">
                <a href="mailto:Salam1998na@gmail.com" class="link" target="_blank"><i class="ti-email"></i></a>
                <a href="https://www.linkedin.com/in/salam-arida/" class="link" target="_blank"><i class="ti-linkedin"></i></a>
                <a href="https://github.com/SalamA98" class="link" target="_blank"><i class="ti-github"></i></a>
            </div>
        </footer>
